...
class _FAQScreenState extends State<FAQScreen> {
  ...
  final List<FAQItem> _faqItems = [
    ...
    FAQItem(
      question: '5. 온라인상품권을 신청했는데 받지 못했어요.',
      answer:
          '온라인상품권은 신청 즉시 문자로 발송됩니다. 받지 못하셨다면 아래를 확인해 주세요.\n[하나] 휴대폰 번호 확인\n신청 시 입력하신 휴대폰 번호가 정확한지 확인해 주세요.\n[둘] 스팸 메시지함 확인\n스팸 메시지함으로 분류되어 있는 경우가 많습니다.\n위 두 가지를 확인하셔도 찾을 수 없다면 이메일로 문의해 주시면 확인해 드리겠습니다.',
    ),
  ];
