# Firebase Auth
  ...
  # Keep custom classes
  -keep class com.reviewtube.pigmoney.** { *; }
  -keep class com.reviewtube.pigmoney.StepCounterService { *; }
  -keep class com.reviewtube.pigmoney.BootReceiver { *; }
